...
namespace _365Beauty.Command.Domain.Constants.Staffs
{
    public class StaffCatalogConst
    {
        ...
        public const string FIELD_STAFF_TEL_OTHER = "staff_tel_other";
        public const string FIELD_STAFF_INTRODUCTION = "staff_introduction";
        public const string FIELD_STAFF_CATALOG_CONTENT = "staff_content";
        public const string FIELD_STAFF_CATALOG_IMG = "staff_img";
        public const string FIELD_STAFF_CATALOG_ADDRESS = "staff_address";
        public const string FIELD_STAFF_CATALOG_CREATED_DATE = "staff_created_date";
        public const string FIELD_STAFF_CATALOG_UPDATED_DATE = "staff_updated_date";
