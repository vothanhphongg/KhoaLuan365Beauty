...
namespace _365Beauty.Command.Domain.Entities.Staffs
{
    public class StaffCatalog : AggregateRoot<int>
    {
        ...
        public void Update(string? code = null, string? idCard = null, string? fullName = null, int? gender = null,
                           DateTime? dateOfBirth = null, string? email = null, string? tel = null, string? telOther = null,
                           string? introduction = null, string? content = null, string? img = null, int? degreeId = null, int? titleId = null,
                           int? occupationId = null, string? address = null, string? wardId = null, int? isActived = null)
        {
            Code = code ?? Code;
