...
{
    public class GetAllUserBookingByUserIdHandler : IRequestHandler<GetAllUserBookingByUserIdQuery, Result<List<UserBookingActivedDTO>>>
    {
        ...
        public GetAllUserBookingByUserIdHandler(IUserBookingRepository userBookingRepository, 
        ...
        public async Task<Result<List<UserBookingActivedDTO>>> Handle(GetAllUserBookingByUserIdQuery request, CancellationToken cancellationToken)
        {
