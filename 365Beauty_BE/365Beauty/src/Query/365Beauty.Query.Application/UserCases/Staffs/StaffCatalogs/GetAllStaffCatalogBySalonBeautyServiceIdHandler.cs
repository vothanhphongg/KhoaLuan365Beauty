...
{
    public class GetAllStaffCatalogBySalonBeautyServiceIdHandler : IRequestHandler<GetAllStaffCatalogByBeautySalonServiceIdQuery, Result<List<StaffCatalogDTO>>>
    {
        ...
        public GetAllStaffCatalogBySalonBeautyServiceIdHandler(IStaffCatalogRepository staffCatalogRepository, 
        ...
        public async Task<Result<List<StaffCatalogDTO>>> Handle(GetAllStaffCatalogByBeautySalonServiceIdQuery request, CancellationToken cancellationToken)
        {
            ...
            var userBooking = userBookingRepository.FindAll(false,
                x => x.SalonServiceId == request.BeautySalonServiceId
                     ...
                     && x.TimeId == request.TimeId).ToList();
